                ...
                <div data-aos="zoom-in" className="grid md:grid-cols-3 pb-44 pt-5">
                    <div className="px-4 py-8">
                        <h1 className="sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3">
                            Shopsy
                            <img className="max-w-[50px]" src={footerLogo} alt="Footer Logo" />
                        </h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo aut cumque consectetur dolorum reprehenderit delectus.</p>
                    </div>
